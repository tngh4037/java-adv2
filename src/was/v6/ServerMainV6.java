...
public class ServerMainV6 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        servletManager.add("/", new HomeServlet()); // 참고) 메서드 이름으로 / 를 쓸수 없기에 따로 등록해주었다.
        servletManager.add("/favicon.ico", new DiscardServlet()); // 참고) 메서드 이름으로 favicon.ico 를 쓸수 없기에 따로 등록해주었다.
